package ko.maeng.base.java.etc.tutorials.io.createfiles;
...
public class CreateFilesUnitTest {
    ...
    public static void clean() {
        ...
        File file1 = new File(tempDir.getAbsolutePath() + "/testFile.txt");
        File file2 = new File(tempDir, "newFile.txt");
        File file3 = new File(tempDir.getAbsolutePath() + File.separator + "newFile2.txt");
        file1.delete();
        file2.delete();
        file3.delete();
    }
    ...
    public void givenAnExistingDirectory_whenCreatingAFileWithAbsolutePath_thenFileIsCreated() throws IOException {
        File tempDir = new File(System.getProperty("java.io.tmpdir"));
        File fileWithAbsolutePath = new File(tempDir.getAbsolutePath() + "/testFile.txt");
