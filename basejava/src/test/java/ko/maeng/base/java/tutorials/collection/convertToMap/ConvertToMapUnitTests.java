package ko.maeng.base.java.tutorials.collection.convertToMap;
...
public class ConvertToMapUnitTests {
    ...
    public void whenCreateConcurrentHashMap() {
        assertTrue(convertToMap.listToConcurrentmap(bookList) instanceof ConcurrentMap);
    }
