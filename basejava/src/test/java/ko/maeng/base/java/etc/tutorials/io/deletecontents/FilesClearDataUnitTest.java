package ko.maeng.base.java.etc.tutorials.io.deletecontents;
...
public class FilesClearDataUnitTest {
    ...
    public void givenExistingFile_whenDeleteContentUsingPrintWritter_thenEmptyFile() throws IOException {
        ...
        writer.print("");
        writer.close();
        assertThat(StreamUtils.getStringFromInputStream(new FileInputStream(FILE_PATH)).length()).isEqualTo(0);
    }

    @Test
    public void givenExistingFile_whenDeleteContentUsingPrintWritterWithOutObject_thenEmptyFile() throws IOException {
